...
Fulfilled: The operation has completed successfully and the promise now has a resolved value. For example, a request’s promise might resolve with a 
Preview: Docs Loading link description
JSON
 object as its value.
